...
<div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item">
                <a href="{{ route('center') }}" class="sidebar-link text-muted active">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#system" aria-expanded="false" aria-controls="system" class="sidebar-link text-muted"><i class="o-wireframe-1 mr-3 text-gray"></i><span>System</span></a>
            <div id="system" class="collapse">
              <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
                <li class="sidebar-list-item"><a href="{{ route('sidenavs.index') }}" class="sidebar-link text-muted pl-lg-5">Menu Settings</a></li>
                <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted pl-lg-5">Page two</a></li>
                <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted pl-lg-5">Page three</a></li>
                <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted pl-lg-5">Page four</a></li>
              </ul>
